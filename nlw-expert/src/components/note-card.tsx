...
//Import * pega todas as exportações e coloca dentro do obj denominado dialog
//dialog.trigger usado no elemento que abre o modal ao clicar
//dialog.content conteúdo que será mostrado no modal
//dialog.portal teleporta o conteúdo para a raiz da aplicação
//dialog.overlay efeito ao clicar, tela com opacidade 
//translate faz com que o elemento se mova conforme seu tamanho, centralizando
