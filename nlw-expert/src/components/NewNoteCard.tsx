...
import { NewNoteCardprops } from './new-note-card';
...
export function NewNoteCard(onNoteCreated: NewNoteCardprops) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="flex flex-col rounded-md bg-slate-700 p-5 text-left gap-3 outline-none hover:ring-slate-600 focus-visible hover:ring-2 focus-visible:ring-lime-400 outline-none">
